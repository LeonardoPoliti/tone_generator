...
Each run writes an audio file plus a `<file>.json` recording every
parameter used. The auto-generated filename encodes frequency, duration, 
and ramp (e.g. `tone_750hz_75ms_10msramp.wav`); use
